...
const OurWork: React.FC = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center mt- justify-center p-6">


    <div className="w-[350px] mb-20 lg:w-[750px] h-[100px]"> 
  <AdButton/>
  </div>
  <div className="text-center lg:text-start flex lg:justify-start text-[#181A2A] text-[24px] font-semibold">
        <p>Latest Post</p>
      </div>
  ...
  className="mt-6 text-[16px] text-[#696A75] border border-[#696A754D] py-4 px-6 rounded-lg 
             hover:text-[#4B5563] hover:border-[#696A75] hover:bg-[#F3F4F6] transition duration-300"
>
  View All Post
</button>
